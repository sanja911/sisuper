			...
			<form action="<?= base_url('datawarga/aksitambah'); ?>" method="POST">
			  ...
			  <div class="form-row">			    
				...
				<div class="form-group col-md-6">
				  ...
				  <select name="statusperkawinan" id="inputState" class="form-control" disabled>
			  ...
			  <div class="form-row">			    
				<div class="form-group col-md-6">
				  ...
				  <select name="statusdalamkeluarga" id="inputState" class="form-control" disabled>
				...
				<div class="form-group col-md-6">
				  ...
				  <select id="inputState" name="kepalakeluarga" class="form-control" disabled>
			  ...
			  <div class="form-row">			    
				<div class="form-group col-md-6">
				  ...
				  <input name="ayah" type="text" class="form-control" placeholder="Nama Ayah" value="<?php echo $data[0]->ayah; ?>" disabled>
				</div>
				<div class="form-group col-md-6">
				  <label>Nama Ibu</label>
				  <input name="ibu" type="text" class="form-control" placeholder="Nama Ibu" value="<?php echo $data[0]->ibu; ?>" disabled>
				</div>
			  </div>
			  <div class="form-row">
				  <div class="form-group col-md-6">
					  <label>RT</label>
					  <select name="rt" id="inputState" name="rt" class="form-control" disabled>
						<?php if ($data[0]->rt == ''){ ?>
						<option selected>Pilih...</option>
						<?php }else{ ?>
				...
				<div class="form-row">
				  <div class="form-group col-md-6">
						...
						<select name="statustinggal" id="inputState" name="statusperkawainan" class="form-control" disabled>

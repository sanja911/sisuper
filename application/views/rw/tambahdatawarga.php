			...
			<form action="<?= base_url('datawarga/aksitambah'); ?>" method="POST">
			  <div class="form-row">
				<div class="form-group col-md-6">
				  ...
				  <input name="nokk" type="text" class="form-control" placeholder="No Kartu Keluarga" value="<?php echo $data[0]->nokk; ?>">
				</div>
				<div class="form-group col-md-6">
				  <label for="inputPassword4">NIK</label>
				  <input name="nik" type="text" class="form-control" placeholder="Nomor Induk Kependudukan" value="<?php echo $data[0]->nik; ?>">
				</div>
			  </div>
			  <div class="form-row">			    
				<div class="form-group col-md-6">
				  <label>Nama Lengkap</label>
				  <input name="nama" type="text" class="form-control" placeholder="Nama Lengkap" value="<?php echo $data[0]->nama; ?>">
				</div>
				<div class="form-group col-md-6">
			  ...
			  <div class="form-row">
				<div class="form-group col-md-6">
				  ...
				  <input name="tempatlahir" type="text" class="form-control" placeholder="Tempat Lahir" value="<?php echo $data[0]->tempatlahir; ?>">
				</div>
				<div class="form-group col-md-6">
				  <label>Tanggal Lahir</label>
				  <input name="tanggallahir" type="date" class="form-control" placeholder="Nomor Induk Kependudukan" value="<?php echo $data[0]->tanggallahir; ?>">
				</div>
			  </div>
			  <div class="form-row">
				<div class="form-group col-md-6">
				...
				<div class="form-group col-md-6">
				  ...
				  <select name="pendidikan" id="inputState" class="form-control">
			  ...
			  <div class="form-row">			    
				<div class="form-group col-md-6">
				  ...
				  <input name="jenispekerjaan" type="text" class="form-control" placeholder="Jenis Pekerjaan" value="<?php echo $data[0]->jenispekerjaan; ?>">
				</div>
				<div class="form-group col-md-6">
			  ...
			  <div class="form-row">			    
				<div class="form-group col-md-6">
				  ...
				  <input name="ayah" type="text" class="form-control" placeholder="Nama Ayah" value="<?php echo $data[0]->ayah; ?>">
				</div>
				<div class="form-group col-md-6">
				  <label>Nama Ibu</label>
				  <input name="ibu" type="text" class="form-control" placeholder="Nama Ibu" value="<?php echo $data[0]->ibu; ?>">
				</div>
			  </div>
			  <div class="form-row">
				  <div class="form-group col-md-6">
				...
				<div class="form-row">
				  ...
				  <div class="form-group col-md-6">
						...
						<textarea name="keterangan" class="form-control" placeholder="Asal Wilayah Domisili" value="<?php echo $data[0]->keterangan; ?>"></textarea>
				  </div>
				</div>
			</form>
		</div>
